...
From LM Require Export logic_tricks.
From LM Require Import hilbert.
From LM Require Export lax_milgram.
...
unfold minus.
rewrite H9.
(* was: replace (a (plus u (opp uh)) u) with
...
rewrite scal_opp_one.
reflexivity.
(*rewrite plus_zero_r; reflexivity. now useless! *)
(* was: replace (M * norm (minus u vh) * norm (minus u uh)) with
